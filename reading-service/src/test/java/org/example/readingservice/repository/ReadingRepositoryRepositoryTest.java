...
import org.example.readingservice.in.controller.AbstractTest;
...
class ReadingRepositoryRepositoryTest extends AbstractTest {
    ...
    void testSaveReading() {
        ...
        SqlRowSet rowSet = jdbcTemplate.queryForRowSet("SELECT * FROM public.reading r WHERE r.personal_account = ?", String.valueOf(personalAccount));
        rowSet.next();
