...
import org.example.readingservice.service.ReadingServiceImpl;
import org.example.readingservice.service.ReadingTypeServiceImpl;
...
public abstract class AbstractTest {
    ...
    private static void createTestData(String jdbcUrl, String username, String password) {
        try(Connection connection = DriverManager.getConnection(jdbcUrl, username, password);
            ...
            stmt.execute("CREATE SEQUENCE IF NOT EXISTS jdbc_sequence START 101");
